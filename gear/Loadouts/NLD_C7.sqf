...
lt_template_scopeSNP         = 	 "cup_optic_sb_3_12x50_pmii_pip";
...
lt_template_rifle = "weapon_C7NLD_nogrip";
lt_template_riflemag   = "30Rnd_556x45_Stanag";
lt_template_riflemag_t = "30Rnd_556x45_Stanag_green";

//Medic, Vehicle crew, Rifleman At
...
// Automatic Rifleman
lt_template_AR = "CUP_lmg_L110A1";
lt_template_ARmag    = "CUP_100Rnd_TE4_Green_Tracer_556x45_M249";
lt_template_ARmag_tr = "CUP_100Rnd_TE4_Green_Tracer_556x45_M249";

// Heavy MG Gunner
lt_template_HMG = "CUP_lmg_FNMAG_RIS_modern";
lt_template_HMGmag    = "150Rnd_762x51_Box_Tracer";
lt_template_HMGmag_tr = "150Rnd_762x51_Box_Tracer";

// Designated Marksman
lt_template_DMrifle = "CUP_arifle_HK417_20";
lt_template_DMriflemag = "CUP_20Rnd_TE1_Green_Tracer_762x51_HK417";
